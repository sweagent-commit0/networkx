...
class Config:
    ...
    def __new__(cls, **kwargs):
        orig_class = cls
        if cls is Config:
            cls = type(cls.__name__, (cls,), {'__annotations__': {key: typing.Any for key in kwargs}})
...
class NetworkXConfig(Config):
    ...
    backends: Config
    cache_converted_graphs: bool
config = NetworkXConfig(backend_priority=[], backends=Config(), cache_converted_graphs=bool(os.environ.get('NETWORKX_CACHE_CONVERTED_GRAPHS', '')))