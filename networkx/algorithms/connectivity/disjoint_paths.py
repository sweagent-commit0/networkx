...
@nx._dispatchable(graphs={'G': 0, 'auxiliary?': 5}, preserve_edge_attrs={'auxiliary': {'capacity': float('inf')}})
...
@nx._dispatchable(graphs={'G': 0, 'auxiliary?': 5}, preserve_node_attrs={'auxiliary': {'id': None}}, preserve_graph_attrs={'auxiliary'})
